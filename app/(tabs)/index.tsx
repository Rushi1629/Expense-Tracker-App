      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <TouchableOpacity style={styles.searchIcon}>
            <Icons.MagnifyingGlassIcon size={verticalScale(20)} color={colors.neutral200} weight='bold' />
          </TouchableOpacity>
        ...
        <ScrollView contentContainerStyle={styles.scrollViewStyle} showsVerticalScrollIndicator={false}>
          ...
          <TransactionList loading={transactionLoading} emptyListMessage='No Transactions Added Yet!' data={recentTransactions} title='Recent Transctions' />
        </ScrollView>
